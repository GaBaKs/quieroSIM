...
export const translations: Record<Language, any> = {
  ES: {
    ...
    destinations: {
      ...
      subtitle: 'Cobertura en más de 190 destinos con las mejores redes locales y estabilidad garantizada. Se activa cuando comenzás a consumir.',
    ...
    checkout: {
      ...
      scanInstruction: 'Escanea el QR con la cámara de tu móvil para descargar el perfil. Se activa cuando comenzás a consumir datos.',
      ...
      free: 'Gratis',
      useCredit: 'Usar mi crédito (US${amount})',
      creditMax: 'Máx',
      creditSplit: 'Crédito: −US${credit} · Tarjeta: US${card}',
      creditCoversAll: 'Cubierto con crédito (−US${credit}). No pasa por la tarjeta.',
      paying: 'Procesando…',
    ...
    auth: {
      ...
      errorEmailInvalid: 'El email no es válido. Revisá que esté bien escrito.',
      errorRateLimit: 'Demasiados intentos. Esperá un momento y volvé a probar.',
      errorCaptcha: 'No se pudo verificar el captcha. Esperá a que termine de cargar y reintentá.',
  ...
  EN: {
    ...
    destinations: {
      ...
      subtitle: 'Coverage in over 190 destinations with the best local networks and guaranteed stability. It activates when you start consuming.',
    ...
    checkout: {
      ...
      scanInstruction: 'Scan the QR code with your mobile camera to download the profile. It activates when you start consuming data.',
      ...
      free: 'Free',
      useCredit: 'Use my credit (US${amount})',
      creditMax: 'Max',
      creditSplit: 'Credit: −US${credit} · Card: US${card}',
      creditCoversAll: 'Covered with credit (−US${credit}). No card charge.',
      paying: 'Processing…',
    ...
    auth: {
      ...
      errorEmailInvalid: 'That email is not valid. Please check the spelling.',
      errorRateLimit: 'Too many attempts. Wait a moment and try again.',
      errorCaptcha: 'We could not verify the captcha. Wait for it to finish loading and retry.',
  ...
  PT: {
    ...
    destinations: {
      ...
      subtitle: 'Cobertura em mais de 190 destinos com as melhores redes locais e estabilidade garantida. É ativado quando você começa a consumir.',
    ...
    checkout: {
      ...
      scanInstruction: 'Escaneie o QR com a câmera do celular para baixar o perfil. Ativa-se quando você começa a consumir dados.',
      ...
      free: 'Grátis',
      useCredit: 'Usar meu crédito (US${amount})',
      creditMax: 'Máx',
      creditSplit: 'Crédito: −US${credit} · Cartão: US${card}',
      creditCoversAll: 'Coberto com crédito (−US${credit}). Não passa pelo cartão.',
      paying: 'Processando…',
    ...
    auth: {
      ...
      errorEmailInvalid: 'O e-mail não é válido. Verifique se está escrito corretamente.',
      errorRateLimit: 'Muitas tentativas. Espere um momento e tente novamente.',
      errorCaptcha: 'Não foi possível verificar o captcha. Espere o carregamento e tente de novo.',
