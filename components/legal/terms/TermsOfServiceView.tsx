...
import TermsOfServiceES from './TermsOfServiceES';
...
export default function TermsOfServiceView() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 antialiased" id="terms-policy-view">
      {/* Mini header/Navbar */}
