            ...
            return (
              <motion.div 
                ...
                className={`rounded-2xl border transition-[border,background,shadow] duration-300 overflow-hidden ${
                  isOpen 
                    ? 'border-[#9933c1]/40 bg-[#9933c1]/[0.02] shadow-[0_4px_20px_rgba(153,51,193,0.03)]' 
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between p-5 sm:p-6 text-left hover:bg-zinc-50/20 transition duration-200 cursor-pointer"
                  aria-expanded={isOpen}
                >
                  <span className={`font-sans font-extrabold text-sm sm:text-base pr-4 transition-colors duration-200 ${
                    isOpen ? 'text-[#9933c1]' : 'text-slate-900'
                  }`}>
                    {faq.q}
                  </span>
                ...
                <AnimatePresence initial={false}>
                  {isOpen && (
                    ...
                    >
                      ...
                      <div className="px-5 pb-6 sm:px-6 sm:pb-7 text-xs sm:text-sm text-slate-600 border-t border-[#9933c1]/10 pt-4 leading-relaxed font-sans">
                        {faq.a}
                      </div>
                    </motion.div>
                  )}
