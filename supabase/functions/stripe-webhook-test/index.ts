// ⚠️ COPIA de ../stripe-webhook SOLO para testing local (Stripe modo test).
// Diferencia: lee STRIPE_SECRET_KEY_TEST y STRIPE_WEBHOOK_SECRET_TEST. NO se usa en prod.
// Si cambia ../stripe-webhook/index.ts, re-sincronizar este archivo.
